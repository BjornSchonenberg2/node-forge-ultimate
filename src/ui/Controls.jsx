...
export const IconBtn = ({ label, onClick, title, style, children }) => (
  <button
    type="button"
    title={title || label}
    onMouseDown={stop}
    onPointerDown={stop}
    onClick={(e) => { stop(e); onClick && onClick(e); }}
    style={{
...
export const Input = (props) => (
    <input
        ...
        onPointerDownCapture={(e) => {
            e.stopPropagation();
            props.onPointerDownCapture && props.onPointerDownCapture(e);
        }}
        onPointerUpCapture={(e) => {
            e.stopPropagation();
            props.onPointerUpCapture && props.onPointerUpCapture(e);
        }}
        onClick={(e) => {
            e.stopPropagation();
